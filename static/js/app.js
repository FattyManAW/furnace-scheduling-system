...
async function init() {
  ...
  if (window.INIT_DATA) {
    state.products = window.INIT_DATA.products;
    state.orders = window.INIT_DATA.orders;
    state.dryers = window.INIT_DATA.dryers;
    state.molds = window.INIT_DATA.molds;
    state.processSteps = window.INIT_DATA.steps;
  } else {
    try {
