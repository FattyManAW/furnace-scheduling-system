        ...
        <div className="space-y-4">
          <div className="bg-furnace-card border border-furnace-border rounded-xl p-5">
            ...
            <div className="flex justify-end mt-4 pt-4 border-t border-furnace-border">
              <button className="px-4 py-2 bg-furnace-green text-white rounded-lg text-sm hover:bg-furnace-green/90">儲存設定</button>
            </div>
          </div>
          ...
          <div className="bg-furnace-card border border-furnace-border rounded-xl p-5">
            ...
            <div className="space-y-3">
              {[
                ...
                <label key={s.name} className="flex items-start gap-3 p-3 rounded-lg border border-furnace-border hover:border-furnace-blue/30 cursor-pointer">
          ...
          <div className="bg-furnace-card border border-furnace-border rounded-xl p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="p-4 rounded-xl border border-furnace-border">
                ...
                <button className="px-4 py-2 bg-furnace-blue/10 text-furnace-blue rounded-lg text-sm hover:bg-furnace-blue/20">執行匯入</button>
              </div>
              <div className="p-4 rounded-xl border border-furnace-red/20 bg-furnace-red/5">
                <h3 className="text-sm font-semibold text-furnace-red mb-2">⚠️ 清除排程</h3>
                <p className="text-xs text-furnace-muted mb-3">清除所有排程結果與訂單狀態。此操作不可復原。</p>
                <button className="px-4 py-2 bg-furnace-red/10 text-furnace-red rounded-lg text-sm hover:bg-furnace-red/20">清除排程</button>
              </div>
            </div>
          </div>
          <div className="bg-furnace-card border border-furnace-border rounded-xl p-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div><p className="text-furnace-muted text-xs">排程表</p><p className="font-bold text-furnace-text">schedule_entries</p></div>
            </div>
          </div>
        </div>
      )}
